...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        for letter in vowels:
            ...
            transpose_dict[letter.upper()] = vowels_permutation[i].upper()
            i += 1
    ...
    def decrypt_message(self):
        ...
        for permutation in permutation_list:
            ...
            if(valid_words > valid_words_max):
                ...
                decrypted_best = decrypted_message
                
        decrypted_best = " ".join(decrypted_best)
...
if __name__ == '__main__':
    ...
    message = SubMessage("My name: Sasa. aeiou AEIOU r[t]s!")
    permutation = "iouae"
    enc_dict = message.build_transpose_dict(permutation)
    print("Original message:", message.get_message_text(), "Permutation:", permutation)
    print("Expected encryption:", "My nimo: Sisi. iouae IOUAE r[t]s!")
    print("Actual encryption:", message.apply_transpose(enc_dict))
    enc_message = EncryptedSubMessage(message.apply_transpose(enc_dict))
    print("Decrypted message:", enc_message.decrypt_message())